...
public class TestConstant {
    ...
    public static Line TEST_LINE = new Line(LINE_ID, LINE_NAME, Lists.list(TEST_EDGE, TEST_EDGE_2, TEST_EDGE_3, TEST_EDGE_4), LocalTime.of(0, 0), LocalTime.of(00, 05), 10);
