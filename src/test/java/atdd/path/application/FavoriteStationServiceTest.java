...
public class FavoriteStationServiceTest {
    ...
    public void addFavoriteStation() {
        ...
        FavoriteStationResponse response = favoriteStationService.addFavoriteStation(TEST_USER_EMAIL2, TEST_STATION.getId());
    ...
    public void findAll() {
        ...
        List<FavoriteStationResponse> responses = favoriteStationService.findAll(TEST_USER_EMAIL2);
