...
import static nextstep.api.subway.acceptance.line.LineSteps.지하철노선_단일조회_요청;
import static nextstep.api.subway.acceptance.line.LineSteps.지하철노선_생성_요청;
import static nextstep.api.subway.acceptance.line.LineSteps.지하철노선_수정_요청;
import static nextstep.api.subway.acceptance.line.LineSteps.지하철노선_전체조회_요청;
import static nextstep.api.subway.acceptance.line.LineSteps.지하철노선_제거_요청;
...
class LineDocumentation extends Documentation {
    ...
    void createLine() {
        ...
        지하철노선_생성_요청(name, color, upStationId, downStationId, 10, makeRequestSpec("line-create"));
    }
