...
import static nextstep.core.subway.favorite.step.FavoriteSteps.*;
...
public class FavoriteAcceptanceTest extends AcceptanceTest {
    ...
    class 즐겨찾기_추가 {
        ...
        class 성공 {
            ...
            void 토큰과_함께_즐겨찾기_추가() {
                // when
                즐겨찾기_추가_요청(추가할_즐겨찾기_정보(교대역, 강남역), 정상적인_회원의_토큰);

                // then
                토큰기반_즐겨찾기_목록_검증(확인할_즐겨찾기_정보(교대역, 강남역), 정상적인_회원의_토큰);
            }
        }
        ...
        class 실패 {
            ...
            class 경로_관련 {
                ...
                void 존재하지_않는_출발역으로_즐겨찾기_추가() {
                    // when
                    잘못된_경로로_즐겨찾기_추가_요청(추가할_즐겨찾기_정보(존재하지_않는_역, 강남역), 정상적인_회원의_토큰);
                ...
                void 존재하지_않는_도착역으로_즐겨찾기_추가() {
                    // when
                    잘못된_경로로_즐겨찾기_추가_요청(추가할_즐겨찾기_정보(강남역, 존재하지_않는_역), 정상적인_회원의_토큰);
                ...
                void 출발역과_도착역이_동일하게_즐겨찾기_추가() {
                    // when
                    잘못된_경로로_즐겨찾기_추가_요청(추가할_즐겨찾기_정보(강남역, 강남역), 정상적인_회원의_토큰);
                ...
                void 출발역과_도착역이_연결되지_않은_즐겨찾기_추가() {
                    // when
                    잘못된_경로로_즐겨찾기_추가_요청(추가할_즐겨찾기_정보(강남역, 오이도역), 정상적인_회원의_토큰);
    ...
    class 즐겨찾기_삭제 {
        ...
        class 성공 {
            ...
            void 추가한_즐겨찾기_삭제() {
                // given
                var 성공하는_즐겨찾기_추가_요청 = 즐겨찾기_추가_요청(추가할_즐겨찾기_정보(교대역, 강남역), 정상적인_회원의_토큰);

                // when
                즐겨찾기_삭제_요청(성공하는_즐겨찾기_추가_요청, 정상적인_회원의_토큰);
            ...
            void 추가한_즐겨찾기_모두_삭제() {
                // given
                var 성공하는_첫번째_즐겨찾기_추가_요청 = 즐겨찾기_추가_요청(추가할_즐겨찾기_정보(교대역, 강남역), 정상적인_회원의_토큰);
                var 성공하는_두번째_즐겨찾기_추가_요청 = 즐겨찾기_추가_요청(추가할_즐겨찾기_정보(교대역, 강남역), 정상적인_회원의_토큰);
                var 성공하는_세번째_즐겨찾기_추가_요청 = 즐겨찾기_추가_요청(추가할_즐겨찾기_정보(교대역, 강남역), 정상적인_회원의_토큰);

                // when
                즐겨찾기_삭제_요청(성공하는_첫번째_즐겨찾기_추가_요청, 정상적인_회원의_토큰);
                즐겨찾기_삭제_요청(성공하는_두번째_즐겨찾기_추가_요청, 정상적인_회원의_토큰);
                즐겨찾기_삭제_요청(성공하는_세번째_즐겨찾기_추가_요청, 정상적인_회원의_토큰);
        ...
        class 실패 {
            ...
            void 다른_사용자의_즐겨찾기_삭제() {
                // given
                var 성공하는_즐겨찾기_추가_요청 = 즐겨찾기_추가_요청(추가할_즐겨찾기_정보(교대역, 강남역), 정상적인_회원A의_토큰);

                // when
                잘못된_토큰으로_즐겨찾기_삭제_요청(성공하는_즐겨찾기_추가_요청, 정상적인_회원B의_토큰);

                // then
                토큰기반_즐겨찾기_목록_검증(확인할_즐겨찾기_정보(교대역, 강남역), 정상적인_회원A의_토큰);
            }
            ...
            void 존재하지_않는_즐겨찾기_삭제() {
                ...
                // when
                즐겨찾기_삭제_요청(존재하지_않는_즐겨찾기_번호, 정상적인_회원의_토큰);
