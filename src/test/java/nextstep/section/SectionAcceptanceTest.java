...
public class SectionAcceptanceTest extends AcceptanceTest {
    ...
    public void setUp() {
        ...
        이호선 = createLine("2호선", "green", 강남역, 역삼역, 10);
    }
    ...
    void addEndSection() {
        // when
        ExtractableResponse<Response> response = SectionSteps.addSection(이호선, 역삼역, 선릉역, 10);
    ...
    void addMiddleSection() {
        // when
        ExtractableResponse<Response> response = SectionSteps.addSection(이호선, 강남역, 선릉역, 9);
        String locationHeader = response.header("Location");
    ...
    void validateSectionDistance() {
        // when
        ExtractableResponse<Response> response = SectionSteps.addSection(이호선, 강남역, 선릉역, 11);
    ...
    void addStartSection() {
        // when
        ExtractableResponse<Response> response = SectionSteps.addSection(이호선, 선릉역, 강남역, 10);
        String locationHeader = response.header("Location");
    ...
    void validateDuplicateStation() {
        // when
        ExtractableResponse<Response> response = SectionSteps.addSection(이호선, 역삼역, 강남역, 10);
