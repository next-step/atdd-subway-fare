...
import nextstep.core.subway.pathFinder.application.PathFinderTest;
...
public class PathFinderStepDef implements En {
    ...
    public PathFinderStepDef() {
        ...
        When("출발역이 존재하지 않는 출발역으로 경로를 {string} 기준으로 조회할 경우", (String 경로_조회_타입) -> {
            컨텍스트.저장소_정보_추가하기("조회할_구간", 지하철_경로(
        ...
        When("도착역이 존재하지 않는 도착역으로 경로를 {string} 기준으로 조회할 경우", (String 경로_조회_타입) -> {
            컨텍스트.저장소_정보_추가하기("조회할_구간", 지하철_경로(
                    컨텍스트.저장소_숫자_가져오기("오이도역"),
                    컨텍스트.저장소_숫자_가져오기("존재하지_않는_역"),
                    경로_조회_타입_찾기(경로_조회_타입)));
