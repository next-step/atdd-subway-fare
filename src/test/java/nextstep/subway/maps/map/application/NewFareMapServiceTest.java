...
public class NewFareMapServiceTest {

    private NewFareMapService fareMapService;
    ...
    void setUp() {
        ...
        fareMapService = new NewFareMapService(lineService, stationService, pathService, fareCalculator);
    }
