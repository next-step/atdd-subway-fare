...
public class FareMapServiceTest {
    ...
    void setUp() {
        ...
        mapService = new FareMapService(lineService, stationService, pathService, fareCalculator);
    }
    ...
    void findPath() {
        ...
        FarePathResponse pathResponse = mapService.findPath(1L, 3L, PathType.DISTANCE);
