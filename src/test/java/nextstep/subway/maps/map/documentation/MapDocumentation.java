...
public class MapDocumentation extends Documentation {
    ...
    void findMap() {
        ...
        LineStationResponse lineStation1 = new LineStationResponse(StationResponse.of(station1), station2.getId(), 1L, 3, 3);
        ...
        given().log().all().
                ...
                apply(document("maps/find",
                        ...
                        responseFields(
                                ...
                                fieldWithPath("lineResponses[].stations[].station").type(JsonFieldType.OBJECT).description("지하철 역 정보"),
                                fieldWithPath("lineResponses[].stations[].station.id").type(JsonFieldType.NUMBER).description("지하철 역 아이디"),
                                fieldWithPath("lineResponses[].stations[].station.name").type(JsonFieldType.STRING).description("지하철 역 이름"),
                                fieldWithPath("lineResponses[].stations[].preStationId").type(JsonFieldType.NUMBER).optional().description("이전 역 아이디"),
