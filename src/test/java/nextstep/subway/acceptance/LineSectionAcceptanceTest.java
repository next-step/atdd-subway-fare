...
class LineSectionAcceptanceTest extends AcceptanceTest {
    ...
    public void setUp() {
        ...
        final Map<String, Object> lineCreateParams = createLineCreateParams(강남역, 양재역);
        신분당선 = 지하철_노선_생성_요청(defaultRequestSpecification(), lineCreateParams).jsonPath().getLong("id");
    }
    ...
    private Map<String, Object> createLineCreateParams(Long upStationId, Long downStationId) {
        ...
        lineCreateParams.put("duration", 8);
