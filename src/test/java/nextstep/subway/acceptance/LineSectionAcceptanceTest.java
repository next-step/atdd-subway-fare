...
class LineSectionAcceptanceTest extends AcceptanceTest {
    ...
    public void setUp() {
        ...
        Map<String, String> lineCreateParams = LineSteps.createLineCreateParams(강남역, 양재역, 10, 10);
    ...
    void addLineSection() {
        ...
        지하철_노선에_지하철_구간_생성_요청(신분당선, LineSteps.createSectionCreateParams(양재역, 정자역, 10, 10));
    ...
    void addLineSectionMiddle() {
        // when
        Long 정자역 = 지하철역_생성_요청("정자역").jsonPath().getLong("id");
        지하철_노선에_지하철_구간_생성_요청(신분당선, LineSteps.createSectionCreateParams(강남역, 정자역, 10, 10));
    ...
    void addSectionAlreadyIncluded() {
        // when
        ExtractableResponse<Response> response = 지하철_노선에_지하철_구간_생성_요청(신분당선, LineSteps.createSectionCreateParams(강남역, 양재역, 10, 10));
