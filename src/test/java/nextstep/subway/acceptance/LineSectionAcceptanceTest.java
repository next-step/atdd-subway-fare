...
class LineSectionAcceptanceTest extends AcceptanceTest {
    ...
    void addLineSection() {
        ...
        지하철_노선에_지하철_구간_생성_요청(신분당선, 구간_추가_요청_생성(양재역, 정자역, DISTANCE, DURATION));
    ...
    void addLineSectionMiddle() {
        // when
        Long 정자역 = 지하철역_생성_요청("정자역").jsonPath().getLong("id");
        지하철_노선에_지하철_구간_생성_요청(신분당선, 구간_추가_요청_생성(강남역, 정자역, DISTANCE, DURATION));
    ...
    void addSectionAlreadyIncluded() {
        // when
        ExtractableResponse<Response> response = 지하철_노선에_지하철_구간_생성_요청(신분당선, 구간_추가_요청_생성(강남역, 양재역, DISTANCE, DURATION));
