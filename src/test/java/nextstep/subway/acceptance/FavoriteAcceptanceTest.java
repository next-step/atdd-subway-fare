...
public class FavoriteAcceptanceTest extends AcceptanceTest {
    ...
    public void setUp() {
        ...
        final int ADDITIONAL_FARE = 0;
        이호선 = 지하철_노선_생성_요청_하고_ID_반환(
            createLineCreateParams("2호선", "green", 교대역, 강남역, 10, DURATION, ADDITIONAL_FARE)
        );
        신분당선 = 지하철_노선_생성_요청_하고_ID_반환(
            createLineCreateParams("신분당선", "red", 강남역, 양재역, 10, DURATION, ADDITIONAL_FARE)
        );
        삼호선 = 지하철_노선_생성_요청_하고_ID_반환(
            createLineCreateParams("3호선", "orange", 교대역, 남부터미널역, 2, DURATION, ADDITIONAL_FARE)
        );

        지하철_노선에_지하철_구간_생성_요청(삼호선, createSectionCreateParams(남부터미널역, 양재역, 3, DURATION));
