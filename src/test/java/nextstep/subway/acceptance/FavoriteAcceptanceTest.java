...
public class FavoriteAcceptanceTest extends AcceptanceTest {
    ...
    public void setUp() {
        ...
        지하철_노선에_지하철_구간_생성_요청(관리자, 삼호선, createSectionCreateParams(남부터미널역, 양재역, 3, 13));
    ...
    void manageFavorite() {
        // when
        ExtractableResponse<Response> createResponse = 즐겨찾기_생성을_요청(사용자, 강남역, 남부터미널역, FindPathType.DISTANCE.getType());
        // then
    ...
    void invalidPath() {
        // when
        ExtractableResponse<Response> createResponse = 즐겨찾기_생성을_요청(사용자, 강남역, 광교역, FindPathType.DISTANCE.getType());
        // then
