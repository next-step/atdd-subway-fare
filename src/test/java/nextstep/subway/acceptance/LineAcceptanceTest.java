...
class LineAcceptanceTest extends AcceptanceTest {
    ...
    void createLine() {
        // when
        ExtractableResponse<Response> response = 지하철_노선_생성_요청("2호선", "green", 900);
    ...
    void getLines() {
        // given
        지하철_노선_생성_요청("2호선", "green", 500);
        지하철_노선_생성_요청("3호선", "orange", 900);
    ...
    void getLine() {
        // given
        ExtractableResponse<Response> createResponse = 지하철_노선_생성_요청("2호선", "green", 900);
