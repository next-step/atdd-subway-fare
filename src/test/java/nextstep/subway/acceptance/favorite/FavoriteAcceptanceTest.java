...
class FavoriteAcceptanceTest extends AcceptanceTest {
    ...
    public void setUp() {
        ...
        이호선_id = 지하철노선_생성_후_ID_반환(이호선, "green", 교대역_id, 강남역_id, 10L, 2L, 0L);
        신분당선_id = 지하철노선_생성_후_ID_반환(신분당선, "bg-red-600", 강남역_id, 양재역_id, 10L, 2L, 0L);
        삼호선_id = 지하철노선_생성_후_ID_반환(삼호선, "orange", 교대역_id, 남부터미널역_id, 2L, 2L, 0L);

        지하철구간_생성(삼호선_id, 남부터미널역_id, 양재역_id, 3L, 2L);
