...
import static nextstep.subway.acceptance.PathSteps.두_역의_최단_거리_경로_조회;
...
class PathAcceptanceTest extends AcceptanceTest {
    ...
    public void setUp() {
        ...
        이호선 = 지하철_노선_생성_요청("2호선", "green", 교대역, 강남역, 10, 15);
        신분당선 = 지하철_노선_생성_요청("신분당선", "red", 강남역, 양재역, 10, 13);
    ...
    void findPathByDistance() {
        // when
        val response = 두_역의_최단_거리_경로_조회(교대역, 양재역);
