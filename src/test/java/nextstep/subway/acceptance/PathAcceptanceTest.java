...
class PathAcceptanceTest extends AcceptanceTest {
    ...
    void findPathByDistance() {
        // when
        ExtractableResponse<Response> response = 두_역의_경로_조회를_요청(교대역, 양재역, PathSearchType.DISTANCE);
    ...
    void findPathByDuration() {
        // when
        ExtractableResponse<Response> response = 두_역의_경로_조회를_요청(교대역, 양재역, PathSearchType.DURATION);
