...
public class PathAcceptanceTest extends AcceptanceTest {
    ...
    public void setUp() {
        ...
        이호선 = 응답에서_id_조회(지하철_노선_생성_요청("2호선", "green", 교대역, 강남역, 교대_강남_거리, 10, 0));
        신분당선 = 응답에서_id_조회(지하철_노선_생성_요청("신분당선", "red", 강남역, 양재역, 강남_양재_거리, 10, 0));
        삼호선 = 응답에서_id_조회(지하철_노선_생성_요청("3호선", "orange", 교대역, 남부터미널역, 교대_남부터미널_거리, 10, 0));
    ...
    void 세_노선에_걸친_역_간의_경로를_찾을_수_있다() {
        ...
        응답에서_id_조회(지하철_노선_생성_요청("4호선", "cyan", 강남역, 선릉역, 강남_선릉_거리, 10, 0));
    ...
    void 출발지와_도착지가_연결되어_있지_않으면_실패한다() {
        ...
        응답에서_id_조회(지하철_노선_생성_요청("가상선", "yellow", 가상의역_1, 가상의역_2, 10, 10, 0));
