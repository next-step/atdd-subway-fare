...
class PathAcceptanceTest extends AcceptanceTest {
     ...
     * Then 최단 거리 경로를 확인할 수 있다.
     */
    @DisplayName("두 역의 최단 거리 경로를 조회한다.")
    @Test
    void findPathByDistance() {
        // when
        ExtractableResponse<Response> response = 두_역의_경로_조회를_요청(defaultRequestSpecification(), 교대역, 양재역, "distance");
    ...
    /**
     * When 두 역의 최단 시간 경로를 조회하면
     * Then 최단 시간 경로를 확인할 수 있다.
     */
    @DisplayName("두 역의 최단 시간 경로를 조회한다.")
    @Test
    void findPathByDuration() {
        // when
        ExtractableResponse<Response> response = 두_역의_경로_조회를_요청(defaultRequestSpecification(), 교대역, 양재역, "duration");
    ...
    /**
     * When 두 역의 최단 거리 경로를 조회하면
     * Then 최단 거리에 대한 요금을 확인할 수 있다.
     */
    @DisplayName("거리에 따른 요금을 조회한다.")
    @Test
    void getCalculatedFareAboutDistance() {
        // when
        ExtractableResponse<Response> response = 두_역의_경로_조회를_요청(defaultRequestSpecification(), 교대역, 양재역, "distance");
    ...
    private Long 지하철_노선_생성_요청(String name, String color, Long upStation, Long downStation, int distance, final int duration) {
        final Map<String, Object> lineCreateParams = new HashMap<>();
