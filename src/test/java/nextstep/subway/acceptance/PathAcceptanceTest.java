...
class PathAcceptanceTest extends AcceptanceTest {
    ...
    void findPathByDistance(final String 조회조건, final String desc) {
    ...
    private static Stream<Arguments> providerSearchType() {
        return Stream.of(
                Arguments.of(SearchType.DISTANCE.getType(), SearchType.DISTANCE.getDesc()),
                Arguments.of(SearchType.DURATION.getType(), SearchType.DURATION.getDesc())
        );
    }
}
