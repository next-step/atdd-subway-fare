...
class PathAcceptanceTest extends AcceptanceTest {
    ...
    public void setUp() {
        ...
        이호선 = 지하철_노선_생성_요청("2호선", "green", 교대역, 강남역, 10, 2, 300);
        신분당선 = 지하철_노선_생성_요청("신분당선", "red", 강남역, 양재역, 15, 2, 500);
        삼호선 = 지하철_노선_생성_요청("3호선", "orange", 교대역, 남부터미널역, 7, 5, 900);
    ...
    @DisplayName("노선 추가 요금-12km 요금 + 노선(900원) 요금")
    @Test
    void 노선_추가_요금() {
        // when
        ExtractableResponse<Response> 최단_거리_경로_조회 = 두_역의_경로_조회를_요청(교대역, 양재역, WeightType.DISTANCE);
