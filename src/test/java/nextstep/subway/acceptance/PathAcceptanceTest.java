...
class PathAcceptanceTest extends AcceptanceTest {
    ...
    public void setUp() {
        ...
        신분당선 = 지하철_노선_생성_요청(관리자, "신분당선", "red", 강남역, 양재역, 10, 2);
    ...
    @DisplayName("두 역의 최단 소요 시간 경로를 조회한다.")
    @Test
    void findPathByDuration() {
        // when
        ExtractableResponse<Response> response = 두_역의_최단_소요시간_조회를_요청(교대역, 양재역);
    ...
    private ExtractableResponse<Response> 두_역의_최단_소요시간_조회를_요청(Long source, Long target) {
        return RestAssured
                .given().log().all()
                .accept(MediaType.APPLICATION_JSON_VALUE)
