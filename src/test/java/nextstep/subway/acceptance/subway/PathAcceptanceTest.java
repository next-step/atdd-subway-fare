...
import static nextstep.subway.acceptance.subway.PathSteps.경로_조회_요청;
...
class PathAcceptanceTest extends AcceptanceTest {
    ...
    public void setUp() {
        ...
        이호선 = 지하철_노선_생성_요청("2호선", "green", 교대역, 강남역, 1);
        신분당선 = 지하철_노선_생성_요청("신분당선", "red", 강남역, 양재역, 2);
        삼호선 = 지하철_노선_생성_요청("3호선", "orange", 교대역, 남부터미널역, 1);

        지하철_노선에_지하철_구간_생성_요청(삼호선, createSectionCreateParams(남부터미널역, 양재역, 1));
    }

    /**
     * 기존 테스트 케이스
     */
    @DisplayName("두 역의 경로를 조회한다.")
    @Test
    void findPath() {
        // when
