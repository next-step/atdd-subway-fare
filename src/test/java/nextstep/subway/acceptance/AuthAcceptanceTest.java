...
import static nextstep.subway.acceptance.MemberSteps.회원_정보_조회_실패;
...
class AuthAcceptanceTest extends AcceptanceTest {
    ...
    @DisplayName("Session 로그인 실패 테스트")
    @Test
    void myInfoWithSessionFail() {
        ExtractableResponse<Response> response = 폼_로그인_후_내_회원_정보_조회_요청("NON_USER", "123");
    ...
    public static ExtractableResponse<Response> 폼_로그인_후_내_회원_정보_조회_요청(String email,
        String password) {
        return RestAssured
            .given().log().all()
