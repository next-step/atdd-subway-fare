...
class PathAcceptanceTest extends AcceptanceTest {
    ...
    void findPathByDistanceBetweenDifferentSection() {
        ...
        Long 노선B = 지하철_노선_생성_요청("노선B", "black", 지하철A역, 지하철E역, 2, 10);
        지하철_노선에_지하철_구간_생성_요청(관리자, 노선B, createSectionCreateParams(지하철E역, 지하철D역, 3, 10));

        // when
        ExtractableResponse<Response> response = 두_역의_최단_거리_경로_조회를_요청(given(), 지하철A역, 지하철D역);

        // then
        경로_조회_응답_검증(response, 5, 20, 지하철A역, 지하철E역, 지하철D역);
    }
    ...
    void findPathByDistanceBetween() {
        // given
        지하철_노선_생성_요청("노선A", "white", 지하철A역, 지하철B역, 2, 8);
        지하철_노선_생성_요청("노선B", "black", 지하철B역, 지하철C역, 2, 6);
        ...
        // then
        경로_조회_응답_검증(response, 6, 20, 지하철A역, 지하철B역, 지하철C역, 지하철D역);
    }
    ...
    void findPathByDurationBetweenDifferentSection() {
        ...
        // then
        경로_조회_응답_검증(response, 8, 15, 지하철A역, 지하철B역, 지하철C역, 지하철D역);
    }
    ...
    void findPathByDurationBetweenDifferentDuration() {
        ...
        // then
        경로_조회_응답_검증(response, 8, 10, 지하철A역, 지하철E역, 지하철F역, 지하철D역);
    }
