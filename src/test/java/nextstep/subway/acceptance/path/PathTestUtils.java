...
public class PathTestUtils {
    ...
    public static PathResponse 지하철_최단_경로_조회(String 출발역_URL, String 도착역_URL) {
    ...
    public static void 최단_경로_길이는_다음과_같다(PathResponse 경로_조회_응답, long distance) {
        assertThat(경로_조회_응답.getDistance()).isEqualTo(distance);
    }

    public static void 경로_조회_결과는_다음과_같다(PathResponse 경로_조회_응답, String... 지하철역_URLs) {
