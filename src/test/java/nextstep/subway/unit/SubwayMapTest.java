...
class SubwayMapTest {
    ...
    void findPath() {
        ...
        // when
        Path path = subwayMap.findPath(교대역, 양재역, PathFinderType.DISTANCE);
    ...
    void findPathOppositely() {
        ...
        // when
        Path path = subwayMap.findPath(양재역, 교대역, PathFinderType.DISTANCE);
    ...
    void findPathDuration() {
        ...
        // when
        Path path = subwayMap.findPath(교대역, 양재역, PathFinderType.DURATION);
