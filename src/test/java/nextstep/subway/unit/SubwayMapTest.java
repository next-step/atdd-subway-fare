...
import nextstep.subway.domain.pathtype.DistanceType;
import nextstep.subway.domain.pathtype.DurationType;
...
class SubwayMapTest {
    ...
    void findPathByDistance() {
        ...
        SubwayMap subwayMap = new SubwayMap(lines, new DistanceType());
    ...
    void findPathByDuration() {
        // given
        List<Line> lines = Lists.newArrayList(신분당선, 이호선, 삼호선);
        SubwayMap subwayMap = new SubwayMap(lines, new DurationType());
