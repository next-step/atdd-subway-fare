...
import nextstep.subway.utils.steps.StationSteps;
...
public class PathFixture {
	...
	public static final Long 분당선 = LineSteps.노선_생성_요청("분당선", "노랑", 도곡역, 학여울역, 6, 4, 0).jsonPath().getLong("id");
	public static final Long 삼호선 = LineSteps.노선_생성_요청("3호선", "주황", 도곡역, 개포동역, 4, 5, 0).jsonPath().getLong("id");
}
