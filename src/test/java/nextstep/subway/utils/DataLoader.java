...
public class DataLoader {
    ...
    public void loadData() {
        ...
        memberRepository.save(new Member("teenager@email.com", "password", 13, List.of(RoleType.ROLE_MEMBER.name())));
        memberRepository.save(new Member("child@email.com", "password", 12, List.of(RoleType.ROLE_MEMBER.name())));
    }
}
