...
public class DataLoader {
    ...
    public void loadData() {
        ...
        memberRepository.save(new Member("member@email.com", "password", 6, Arrays.asList(RoleType.ROLE_MEMBER.name())));
        memberRepository.save(new Member(GithubResponses.사용자1.getEmail(), "password", 6, Arrays.asList(RoleType.ROLE_MEMBER.name())));
