...
import nextstep.subway.fixture.FieldFixture;
...
public class JsonPathUtil {
    ...
    public static <T> List<T> List로_추출(ExtractableResponse<Response> API_응답_결과, FieldFixture 추출할_데이터_필드, Class<T> clazz) {
        return API_응답_결과.jsonPath().getList(추출할_데이터_필드.필드명(), clazz);
    }
}
