...
class PathAcceptanceTest extends AcceptanceTest {
    ...
    public void setUp() {
        ...
        이호선 = 지하철_노선_등록되어_있음("2호선", "green", 교대역, 강남역, 10, 10, 0, LocalTime.of(5, 0), LocalTime.of(23, 0), 13);
        신분당선 = 지하철_노선_등록되어_있음("신분당선", "green", 강남역, 양재역, 10, 10, 0, LocalTime.of(5, 0), LocalTime.of(23, 0), 10);
        삼호선 = 지하철_노선_등록되어_있음("3호선", "green", 교대역, 남부터미널역, 2, 10, 0, LocalTime.of(5, 0), LocalTime.of(23, 0), 8);
    ...
    void findPathByDistance() {
        // when
        ExtractableResponse<Response> response = 두_역의_최단_거리_경로_조회를_요청(given(), 양재역.getId(), 교대역.getId());
    ...
    void findPathByArrivalTime() {
        // when
        ExtractableResponse<Response> response = 두_역의_가장_빠른_도착_경로_조회를_요청(양재역.getId(), 교대역.getId());
