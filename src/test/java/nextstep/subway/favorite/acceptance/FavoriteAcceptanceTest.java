...
public class FavoriteAcceptanceTest extends AcceptanceTest {
    ...
    void findFavorites() {
        ...
        // when
        ExtractableResponse<Response> response = 지하철_즐겨찾기_목록_조회_요청(로그인_멤버_토큰);
    ...
    void manageMember() {
        ...
        // when
        ExtractableResponse<Response> createResponse = 지하철_즐겨찾기_추가_요청(로그인_멤버_토큰, 강남역, 청계산입구역);
        // then
        지하철_즐겨찾기_추가_됨(createResponse);

        // when
        ExtractableResponse<Response> findResponse = 지하철_즐겨찾기_목록_조회_요청(로그인_멤버_토큰);
        // then
        지하철_즐겨찾기_조회_됨(findResponse);

        // when
        ExtractableResponse<Response> deleteResponse = 지하철_즐겨찾기_제거_요청(로그인_멤버_토큰, 지하철_즐겨찾기_생성된_ID(createResponse));
        // then
