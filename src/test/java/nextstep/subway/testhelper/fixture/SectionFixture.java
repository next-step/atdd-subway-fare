...
public class SectionFixture {
    ...
    public SectionFixture(StationFixture stationFixture) {
        ...
        잠실역_부터_강남역_구간_params.put("duration", "10");
        ...
        삼성역_부터_선릉역_구간_params.put("duration", "10");
        ...
        선릉역_부터_교대역_구간_params.put("duration", "10");
        ...
        강남역_부터_선릉역_구간_params.put("duration", "5");
        ...
        강남역_부터_삼성역_구간_params.put("duration", "10");
        ...
        선릉역_부터_삼성역_구간_params.put("duration", "3");
    }
