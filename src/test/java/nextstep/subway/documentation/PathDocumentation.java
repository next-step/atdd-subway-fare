...
public class PathDocumentation extends Documentation {
    ...
    void path() {
        ...
        when(pathService.findPath(anyLong(), anyLong(), anyString(), any())).thenReturn(pathResponse);
    ...
    private static ResponseFieldsSnippet 경로_응답_정의() {
        return responseFields(
                ...
                fieldWithPath("duration").description("경로 총 소요 시간"),
                fieldWithPath("fare").description("경로 총 요금")
        );
    }
}
