    ...
    class AddSectionTest {
        ...
        class Success {
            ...
            void 노선_앞에_구간을_추가한다() {
                ...
                // when
                final var response = SectionSteps.지하철구간_등록_성공(lineId, new SectionRequest(교대역, 강남역, 10, 10));
            ...
            void 노선_뒤에_구간을_추가한다() {
                ...
                // when
                final var response = SectionSteps.지하철구간_등록_성공(lineId, new SectionRequest(역삼역, 선릉역, 10, 10));
            ...
            class 노선_중간에_구간을_추가한다 {
                ...
                void 상행역이_동일한_구간을_추가한다() {
                    ...
                    // when
                    final var response = SectionSteps.지하철구간_등록_성공(lineId, new SectionRequest(강남역, 역삼역, 10, 10));
        ...
        class Fail {
            ...
            void 상행역과_하행역_모두_노선에_포함되어_있으면_안된다() {
                ...
                // when & then
                SectionSteps.지하철구간_등록_실패(lineId, new SectionRequest(강남역, 선릉역, 10, 10));
            ...
            void 상행역과_하행역_둘중_하나도_노선에_포함되어_있지_않으면_안된다() {
                ...
                // when & then
                SectionSteps.지하철구간_등록_실패(lineId, new SectionRequest(교대역, 삼성역, 10, 10));
                assertThat(LineSteps.지하철노선을_조회한다(lineId).getStations()).hasSize(2);
            }
            ...
            void 역_사이에_새로운_역을_등록할_경우_새로운_구간의_길이는_기존_역_사이_길이보다_크거나_같아선_안된다(final int length) {
                ...
                // when & then
                SectionSteps.지하철구간_등록_실패(lineId, new SectionRequest(강남역, 역삼역, length, 10));
                assertThat(LineSteps.지하철노선을_조회한다(lineId).getStations()).hasSize(2);
            }
            ...
            void 구간을_등록하고자_하는_노선은_등록되어_있어야_한다() {
                SectionSteps.지하철구간_등록_실패(0L, new SectionRequest(교대역, 삼성역, 10, 10));
            }
            ...
            void 등록하고자_하는_구간의_상행역은_등록되어_있어야_한다() {
                ...
                // when & then
                SectionSteps.지하철구간_등록_실패(lineId, new SectionRequest(0L, 삼성역, 10, 10));
                assertThat(LineSteps.지하철노선을_조회한다(lineId).getStations()).hasSize(2);
            }
            ...
            void 등록하고자_하는_구간의_하행역은_등록되어_있어야_한다() {
                ...
                // when & then
                SectionSteps.지하철구간_등록_실패(lineId, new SectionRequest(교대역, 0L, 10, 10));
                assertThat(LineSteps.지하철노선을_조회한다(lineId).getStations()).hasSize(2);
            }
        }
    }
    ...
    class RemoveSectionTest {
        ...
        class success {
            ...
            void 지하철_구간의_상행_종점역을_삭제한다() {
                ...
                // given
                final var lineId = LineSteps.지하철노선_생성_성공(request).getId();
                SectionSteps.지하철구간_등록_성공(lineId, new SectionRequest(역삼역, 선릉역, 10, 10));
