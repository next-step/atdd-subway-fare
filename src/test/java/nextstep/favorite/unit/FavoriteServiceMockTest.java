...
public class FavoriteServiceMockTest {
    ...
    public void createFavorite_fail() {
        ...
        // when
        assertAll(
                () -> assertThrows(MemberException.class, () -> favoriteService.createFavorite(로그인멤버, 즐겨찾기_요청_강남역_역삼역))
        );
    ...
    public void findFavorites_fail1() {
        ...
        // when & then
        assertAll(
                () -> assertThrows(MemberException.class, () -> favoriteService.findFavorites(로그인멤버))
        );
    ...
    public void deleteFavorite_fail1() {
        ...
        // when & then
        assertAll(
                () -> assertThrows(MemberException.class, () -> favoriteService.deleteFavorite(로그인멤버, anyLong()))
        );
