...
class LineTest {
    ...
    void addEndSection() {
        ...
        Section section = new Section(이호선, 역삼역, 선릉역, 10);
    ...
    void addMiddleSection() {
        Line 이호선 = new Line("2호선", "green", 강남역, 역삼역, 10);
        Section nextSection = new Section(이호선, 역삼역, 선릉역, 10);
        이호선.addSection(nextSection);

        Section middleSection = new Section(이호선, 역삼역, 삼성역, 3);
    ...
    void deleteMiddleSection() {
        Line 이호선 = new Line("2호선", "green", 강남역, 역삼역, 10);
        Section 역삼_선릉 = new Section(이호선, 역삼역, 선릉역, 10);
        이호선.addSection(역삼_선릉);

        Section 선릉_삼성 = new Section(이호선, 선릉역, 삼성역, 10);
