...
public class LineAcceptanceTest extends AcceptanceTest {
    ...
    void createLine() {
        // when
        LineSteps.createLine("신분당선", "bg-red-600", 1L, 2L, 10);
    ...
    void getLines() {
        // given
        LineSteps.createLine("신분당선", "bg-red-600", 1L, 2L, 10);
        LineSteps.createLine("분당선", "bg-green-600", 1L, 3L, 10);
    ...
    void getLine() {
        // given
        ExtractableResponse<Response> line = LineSteps.createLine("신분당선", "bg-red-600", 1L, 2L, 10);
