...
#
  Scenario: 성공 경로 조회시 출발역과 도착역이 연결되어 있을 경우 최소 거리 경로와 기본 요금을 조회할 수 있다
    ...
    And 최소 시간 기준 결과 지하철 이용 요금인 1250원에서 추가 노선 요금인 100원을 더하고 청소년 할인 요금인 350원 공제 후 남은 금액의 20% 할인을 받아 900원을 함께 응답한다
...
#
  Scenario: 성공 경로 조회시 출발역과 도착역이 연결되어 있을 경우 최소 시간 경로를 조회할 수 있다
    ...
    And 최소 시간 기준 결과 지하철 이용 요금인 1350원에서 지하철 추가 요금인 100원을 추가하고 청소년 할인 요금인 350원 공제 후 남은 금액의 20% 할인을 받아 1150원을 함께 응답한다
