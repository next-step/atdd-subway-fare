...
public class ShortestDistancePathFinder implements PathFinder {
    public PathRetrieveResponse findPath(List<Section> sections,
        ...
        Long totalDuration = getDurationInShortestDistancePath(stationsIntPath, sections);
        Double minimumWeight = getWeightOfShortestDistancePath(graph, sourceStation, targetStation);

        return PathRetrieveResponse.builder()
                .stations(StationResponse.from(stationsIntPath))
    ...
    private Double getWeightOfShortestDistancePath(WeightedMultigraph<Station, DefaultWeightedEdge> graph,
                                                   Station sourceStation,
                                                   Station targetStation) {
        try {
