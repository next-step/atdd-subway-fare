...
public class PathInfo {
    ...
    public PathResponse toResponse(StationRepository stationRepository, LineRepository lineRepository) {
        ...
        FareCalculator fareCalculator = new FareCalculator(distance, linesInPath);
