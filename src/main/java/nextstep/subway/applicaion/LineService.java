...
public class LineService {
    ...
    public LineResponse saveLine(LineRequest request) {
        Line line = lineRepository.save(new Line(request.getName(), request.getColor(), request.getOverFare()));
    ...
    public void updateLine(Long id, LineRequest lineRequest) {
        ...
        line.update(lineRequest.getName(), lineRequest.getColor(), line.getOverFare());
    }
