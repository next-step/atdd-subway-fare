...
public class LineExceptionMessage {
    ...
    public static final String EXCEPTION_MESSAGE_INVALID_SECTION_DISTANCE = "새로운 구간의 거리가 기존 구간의 거리보다 크거나 같습니다.";
    public static final String EXCEPTION_MESSAGE_INVALID_SECTION_DURATION = "새로운 구간의 소요 시간이 기존 구간의 소요 시간보다 크거나 같습니다.";
