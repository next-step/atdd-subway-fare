...
public class PathService {
    ...
    public PathResponse findPath(Long source, Long target, PathType type, LoginMember member) {
        ...
        Fare fare = new Fare(pathResult.getTotalDistance(), member.getAge(), pathResult.getLineFare());
