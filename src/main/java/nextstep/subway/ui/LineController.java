...
public class LineController {
    ...
    @PostMapping("/{lindId}/fare")
    public ResponseEntity<Void> updateFare(@PathVariable Long lindId, @RequestBody LineFareRequest lineFareRequest) {
        lineService.updateFare(lindId, lineFareRequest);
        return ResponseEntity.ok().build();
    }
}
