...
public class LineController {
    ...
    @Secured("ROLE_ADMIN")
    @PostMapping
    public ResponseEntity<LineResponse> createLine(@RequestBody LineSectionRequest lineSectionRequest) {
        LineResponse line = lineService.saveLine(lineSectionRequest);
