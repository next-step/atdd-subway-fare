...
public class SubwayMap {
    ...
    private Sections findShortestPathSections(Station source, Station target) {
        ...
        graph = setVertex(graph);
        graph = setEdgeAndWeight(graph);
    ...
    private SimpleDirectedWeightedGraph<Station, SectionEdge> setVertex(SimpleDirectedWeightedGraph<Station, SectionEdge> graph){
        // 지하철 역(정점)을 등록
        lines.stream()
    ...
    private SimpleDirectedWeightedGraph<Station, SectionEdge> setEdgeAndWeight(SimpleDirectedWeightedGraph<Station, SectionEdge> graph){
