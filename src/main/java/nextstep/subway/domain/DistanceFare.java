...
public class DistanceFare {
    ...
    public DistanceFare(int distance) {
        ...
        this.policy = Policy.createFarePolicy(distance);
    }

    public int calculate() {
        return policy.calculate(this.distance);
    }

    enum Policy {
        DEFAULT(0, 10, 0, 0, Policy -> defaultCalculateFare()),
        OVER_10KM(10, 50, 5, 100, Policy::calculateFare10),
        OVER_50KM(50, Integer.MAX_VALUE, 8, 100, Policy::calculateFare50);
        ...
        Policy(int minDistance, int maxDistance, int extraDistance, int extraFare,
        ...
        public static Policy createFarePolicy(int distance) {
