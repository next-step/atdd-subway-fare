    ...
    private void rearrangeSectionWithUpStation(Section section) {
        sections.stream()
                ...
                .ifPresent(it -> {
                    ...
                    sections.add(new Section(section.getLine(), section.getDownStation(), it.getDownStation(), it.getDistance() - section.getDistance(), it.getDistance() - section.getDuration()));
                    sections.remove(it);
                });
    }
