    ...
    private void rearrangeSectionWithDownStation(Section section) {
        sections.stream()
                ...
                .ifPresent(it -> {
                    ...
                    sections.add(new Section(section.getLine(), it.getUpStation(), section.getUpStation(), new Section.SectionInfo(it.getDistance() - section.getDistance(), section.getDuration())));
                    sections.remove(it);
                });
    }
    ...
    private void rearrangeSectionWithUpStation(Section section) {
        sections.stream()
                ...
                .ifPresent(it -> {
                    ...
                    sections.add(new Section(section.getLine(), section.getDownStation(), it.getDownStation(), new Section.SectionInfo(it.getDistance() - section.getDistance(), section.getDuration())));
                    sections.remove(it);
                });
    }
