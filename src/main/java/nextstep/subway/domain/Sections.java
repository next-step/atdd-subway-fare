    ...
    private void rearrangeSectionWithDownStation(Section section) {
        sections.stream()
                ...
                .ifPresent(it -> {
                    ...
                    sections.add(new Section(section.getLine(), it.getUpStation(), section.getUpStation(), it.getDistance() - section.getDistance(), it.getDuration()));
                    sections.remove(it);
                });
    }
    ...
    private void rearrangeSectionWithUpStation(Section section) {
        sections.stream()
                ...
                .ifPresent(it -> {
                    ...
                    sections.add(new Section(section.getLine(), section.getDownStation(), it.getDownStation(), it.getDistance() - section.getDistance(), it.getDuration()));
                    sections.remove(it);
                });
    }
