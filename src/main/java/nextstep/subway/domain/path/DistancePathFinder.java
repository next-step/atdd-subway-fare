...
public class DistancePathFinder implements PathFinder {
    ...
    public DistancePathFinder(final List<Line> lines) {
        this.lines = lines;
    }
    ...
    private void addEdgeWithWeight2(final SimpleDirectedWeightedGraph<Station, SectionEdge> graph) {
        lines.stream()
                .flatMap(it -> it.getSections().stream())
    ...
    private static List<Section> getSectionsOfShortestPath(
