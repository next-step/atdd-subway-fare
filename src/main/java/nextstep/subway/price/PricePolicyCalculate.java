...
public class PricePolicyCalculate implements PricePolicy {

    private Integer totalDistance;
    private Integer age;
    private Integer addtionPrice;

    public PricePolicyCalculate(Integer totalDistance, Integer age, Integer addtionPrice) {
    ...
    public int calculatePrice() {
        ...
        int price = distancePricePolicy.calculatePrice();

        AddtionPricePolicy addtionPricePolicy = new AddtionPricePolicy(price, addtionPrice);
        price = addtionPricePolicy.calculatePrice();
