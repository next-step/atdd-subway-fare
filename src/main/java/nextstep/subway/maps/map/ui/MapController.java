...
public class MapController {
    ...
    @GetMapping("/paths")
    public ResponseEntity<PathResponse> findPath(@AuthenticationPrincipal UserDetails userDetails, PathRequest pathRequest) {
        return ResponseEntity.ok(mapService.findPath(userDetails, pathRequest));
    }
