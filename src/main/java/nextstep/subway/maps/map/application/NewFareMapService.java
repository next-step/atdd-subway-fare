...
@Service
public class NewFareMapService {
    private LineService lineService;
    private StationService stationService;
    private PathService pathService;
    private FareCalculator fareCalculator;

    public NewFareMapService(LineService lineService, StationService stationService, PathService pathService, FareCalculator fareCalculator) {
