...
public class FavoritePathController {
    ...
    @PostMapping
    public ResponseEntity<Void> createFavoritePath(@AuthenticationPrincipal UserPrincipal userPrincipal, @RequestBody FavoritePathRequest request) {
    ...
    public ResponseEntity<Void> deleteFavoritePath(@AuthenticationPrincipal UserPrincipal userPrincipal, @PathVariable Long favoritePathId) {
